...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Aden-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.gohelpfund.com", ""};
...
extern "C" void* ThreadSeeder(void*) {
  ...
  if (fTestNet) {
    // db.Add(CService("sometestnnetnodeip", 19999), true);
     ...
     db.Add(CService("157.230.111.121", 7777), true);
     db.Add(CService("138.197.176.24", 7777), true);
  }
  do {
